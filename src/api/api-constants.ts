...
/** Format validation for path parameters (session IDs, trace IDs, metric names). */
export const PARAM_ID_RE = /^[\w.:\-]{4,128}$/;
/** Format validation for metric name path parameters (allows dots, slashes for namespaced metrics). */
