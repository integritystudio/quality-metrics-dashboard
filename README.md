...
## Project Structure (120,052 tokens)

```
└── src/ (120,052 tokens)
    ├── App.tsx (4,700 tokens)
    ├── main.tsx (332 tokens)
    ...
    ├── contexts/ (3,650 tokens)
    │   ├── AuthContext.tsx (1,279 tokens)
    ...
    │   ├── supabase.ts (2,075 tokens)
    │   ├── symbols.ts (309 tokens)
    │   ├── workflow-graph.ts (2,105 tokens)
    ├── ... (1 more)
    │   └── validation/ (1,679 tokens)
    │       └── auth-schemas.ts (1,679 tokens)
    ├── pages/ (15,350 tokens)
    │   ├── AdminPage.tsx (1,993 tokens)
